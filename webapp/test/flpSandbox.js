		...
		services: {
						...
						"groups": [{
							"tiles": [{
								...
								"properties": {
									...
									"targetURL": "#hexathonemotionsreport-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"hexathonemotionsreport-display": {
								"semanticObject": "hexathonemotionsreport",
								"action": "display",
								"description": "Emotion Report",
								"title": "Emotion Report",
								"signature": {
									"parameters": {}
								},
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=hexathon.emotionsreport",
									"url": sap.ui.require.toUrl("hexathon/emotionsreport")
								}
							}
						}
					}
